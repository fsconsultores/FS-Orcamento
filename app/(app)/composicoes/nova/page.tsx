  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (msg.includes('uq_composicao_codigo')) {
        setError('Já existe uma composição com esse código.');
      } else {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-bold text-gray-900">Nova composição</h1>
      </div>
        ...
        <div className="rounded-xl border bg-white p-5 shadow-sm space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="Ex: Alvenaria de tijolo cerâmico 9x19x19cm"
              className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
            />
          </div>
        </div>
