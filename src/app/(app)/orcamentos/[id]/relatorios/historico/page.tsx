...
export default async function RelatoriosHistoricoPage({
  ...
  // ?planilha=) pros links de "Gerar relatório" — sem isso, /relatorios
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        actions={
          <Link href={`/orcamentos/${orcamentoId}/relatorios${qs}` as any}>
            ...
            {registros.map((r, i) => {
              ...
              return (
                ...
                >
                  ...
                  {report && (
                    <Link
                      href={`/orcamentos/${orcamentoId}/relatorios${qsReport(report.id)}` as any}
