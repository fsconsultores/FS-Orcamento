  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          {MODOS.map(m => (
            <label key={m.value} className="flex items-start gap-2 text-sm text-gray-700 cursor-pointer">
              <input type="radio" name="analitica-modo" className="accent-blue-600 mt-0.5" checked={value.modo === m.value}
      ...
      <label className="flex items-center gap-2 text-sm text-gray-700 cursor-pointer">
        <input type="checkbox" className="accent-blue-600" checked={value.mostrarPrecos}
